...
class Creature : public Unit
{
    ...
    public:
        ...
        /// Whether this one rides the surface of a liquid instead of its floor.
        ///
        /// The single exception to "ground wins": a pet follows its owner out over
        /// water no floor can reach. Asked by the router (Nav::ProfileOf) and by the
        /// swim flag alike, so the route and the animation cannot drift apart on it.
        bool RidesWater() const { return GetOwnerGuid().IsPlayer(); }
