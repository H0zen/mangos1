...
// Spell interrupt / aura-interrupt / spell-modifier enums moved to
// SpellAuraDefines.h (included above): they describe Spell.dbc columns.
...
class Unit : public WorldObject
{
    public:
        ...
        /**
         * @brief Tells whether any aura on this unit could proc from an event.
         *
         * The OR of every held aura's effective proc flags. IsSpellProcEventCanTriggeredBy
         * rejects a holder outright when (procFlags & EventProcFlag) == 0, so a
         * miss against the aggregate means every holder would have been
         * rejected -- and the whole scan can be skipped rather than walked.
         *
         * Recomputed on first use after any aura is added or removed, which is
         * far rarer than the events that consult it.
         *
