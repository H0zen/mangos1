...
class Unit : public WorldObject
{
    public:
        ...
        /// The two proc behaviours still written as a switch on spell id.
        /// Everything else is a free function registered in
        /// src/game/combat/ProcRegistry.cpp; these are reached from there too,
        /// so the table is the only place that decides which aura does what.
        Combat::ProcResult HandleDummyAuraProc(Combat::ProcEvent const& e);
        Combat::ProcResult HandleProcTriggerSpellAuraProc(Combat::ProcEvent const& e);
        void SetLastManaUse()
        {
